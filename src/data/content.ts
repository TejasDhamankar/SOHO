...
export const locationAdvantages: string[] = [
...
export const whoShouldBuy: string[] = [
  "HNI Investors",
  "Farmhouse Buyers",
  "Weekend Home Buyers",
...
export const testimonials: Testimonial[] = [
  { quote: "It feels like a quiet hill-station escape with fresh air and open views.", source: "Rohit Patil, Mumbai" },
  { quote: "Perfect for weekend recreation, greenery and a future farmhouse.", source: "Tejas Deshmukh, Pune" },
  { quote: "Roha feels like it is just entering its next growth chapter.", source: "Anjali Sharma, Navi Mumbai" },
];

export const finalUspList: string[] = [
  "100 Acre Premium Development",
...
export const retreatPillars: string[] = [
  "Pollution-free environment",
  "Fresh, oxygen-rich air",
